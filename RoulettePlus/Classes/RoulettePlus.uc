...
function AssignRandomPerksPlus()
{
	...
	kClass = ESoldierClass(byte(kSoldierUI.m_kSoldier.m_iEnergy));
	
	amnum = kSoldierUI.m_kSoldier.m_arrRandomPerks[22];
    kSoldierUI.m_kSoldier.m_arrRandomPerks.Length = 0;
	
	if(UseVanillaRolls) {
	
		kTag.StrValue1 = "UseVanillaRolls";
		goto end;
	}
    I = 1;
	if(kClass > 0) {
		...
		if(I < 8) {
			...
			if(J < 3) {
				...
				if(arrPerk.Find(Perk) != -1) {
					kSoldierUI.m_kSoldier.m_arrRandomPerks.AddItem(EPerkType(arrPerk.Find(Perk)));
				}
				else {
					K = 0;
					findloop:
					if(K < arrAlias.Length) {
						if(arrAlias[K].Alias.Find(Perk) != -1) {
							kSoldierUI.m_kSoldier.m_arrRandomPerks.AddItem(EPerkType(arrAlias[K].Alias.Find(Perk)));
							goto endfind;
						}
						++ K;
						goto findloop;
	...
	kSoldierUI.m_kSoldier.m_arrRandomPerks[22] = EPerkType(amnum);
}
...
function bool IsRandomPerkValidToAddPlus(string Perk) {
    ...
    if(kSoldierUI.m_kSoldier.m_arrRandomPerks.Find(EPerk) != -1) {
        return false;
    }
    if(kSoldierUI.m_kSoldier.HasPerk(EPerk)) {
        return false;
    }
	I = 0;
	J0x42:
	if(I < IncompatiblePerks1.Length) {
		...
		switch(Perk) {
			case IncompatiblePerks1[I]:
				if(kSoldierUI.m_kSoldier.m_arrRandomPerks.Find(Perk2) != -1 || kSoldierUI.m_kSoldier.HasPerk(Perk2)) {
					return false;
				}
				break;
			case IncompatiblePerks2[I]:
				if(kSoldierUI.m_kSoldier.m_arrRandomPerks.Find(Perk1) != -1 || kSoldierUI.m_kSoldier.HasPerk(Perk1)) {
					return false;
				}
				break;
			default:
	...
	if(I < ChainPerks1.Length) {
		...
		switch((kSoldierUI.m_kSoldier.m_arrRandomPerks.Length) % 3) {
			case 1:
				if((Perk == ChainPerks1[I]) && Perk2 == kSoldierUI.m_kSoldier.m_arrRandomPerks[(kSoldierUI.m_kSoldier.m_arrRandomPerks.Length - 1)]) {
					return false;
				}
				if((Perk == ChainPerks2[I]) && Perk1 == kSoldierUI.m_kSoldier.m_arrRandomPerks[(kSoldierUI.m_kSoldier.m_arrRandomPerks.Length - 1)]) {
					return false;
				}
			case 2:
				if((Perk == ChainPerks1[I]) && ((Perk2 == kSoldierUI.m_kSoldier.m_arrRandomPerks[(kSoldierUI.m_kSoldier.m_arrRandomPerks.Length - 1)]) || (Perk2 == kSoldierUI.m_kSoldier.m_arrRandomPerks[(kSoldierUI.m_kSoldier.m_arrRandomPerks.Length - 2)]))) {
					return false;
				}
				if((Perk == ChainPerks2[I]) && ((Perk1 == kSoldierUI.m_kSoldier.m_arrRandomPerks[(kSoldierUI.m_kSoldier.m_arrRandomPerks.Length - 1)]) || (Perk1 == kSoldierUI.m_kSoldier.m_arrRandomPerks[(kSoldierUI.m_kSoldier.m_arrRandomPerks.Length - 2)]))) {
					return false;
				}
			default:
				break;
	...
	if(I < StaticPerks.Length) {
		if(kSoldierUI.m_kSoldier.m_iEnergy == StaticPerks[I].iClass) {
	...
	if(I < PerkChance.Length) {
		if(PerkChance[I].PerkC == string(0) || PerkChance[I].PerkC == string(EPerk)) {
			if(PerkChance[I].iClass == -1 || PerkChance[I].iClass == kSoldierUI.m_kSoldier.m_iEnergy) {
				if(PerkChance[I].Rank == -1 || ((kSoldierUI.m_kSoldier.m_arrRandomPerks.Length + 3) / 3) == PerkChance[I].Rank ) {
	...
	if(I < ChoicePerks1.Length) {
		...
		if(Perk == ChoicePerks1[I] && kSoldierUI.m_kSoldier.m_arrRandomPerks.Find(Perk2) != -1) {
			switch(kSoldierUI.m_kSoldier.m_arrRandomPerks.Length % 3) {
				case 0:
					return false;
				case 1:
					if(Perk2 != kSoldierUI.m_kSoldier.m_arrRandomPerks[(kSoldierUI.m_kSoldier.m_arrRandomPerks.Length - 1)]) {
						return false;
					}
				case 2:
					if(Perk2 != kSoldierUI.m_kSoldier.m_arrRandomPerks[(kSoldierUI.m_kSoldier.m_arrRandomPerks.Length - 1)] && (Perk2 != kSoldierUI.m_kSoldier.m_arrRandomPerks[(kSoldierUI.m_kSoldier.m_arrRandomPerks.Length - 2)])) {
						return false;
					}
				default:
					break;
		...
		if(Perk == ChoicePerks2[I] && kSoldierUI.m_kSoldier.m_arrRandomPerks.Find(Perk1) != -1) {
			switch(kSoldierUI.m_kSoldier.m_arrRandomPerks.Length % 3) {
				case 0:
					return false;
				case 1:
					if(Perk1 != kSoldierUI.m_kSoldier.m_arrRandomPerks[(kSoldierUI.m_kSoldier.m_arrRandomPerks.Length - 1)]) {
						return false;
					}
				case 2:
					if(Perk1 != kSoldierUI.m_kSoldier.m_arrRandomPerks[(kSoldierUI.m_kSoldier.m_arrRandomPerks.Length - 1)] && (Perk1 != kSoldierUI.m_kSoldier.m_arrRandomPerks[(kSoldierUI.m_kSoldier.m_arrRandomPerks.Length - 2)])) {
						return false;
					}
				default:
					break;
	...
	if(I < RequiredPerk1.Length) {
		...
		if(RequiredPerkClass[I] == -1 || RequiredPerkClass[I] == kSoldierUI.m_kSoldier.m_iEnergy) {
			if(Perk == RequiredPerk1[I]) {
				...
				if(J < RequiredPerk2[I].Perk.Length){
					...
					if(!(kSoldierUI.m_kSoldier.HasPerk(Perk2))) {
						if(kSoldierUI.m_kSoldier.m_arrRandomPerks.Find(Perk2) != -1 && (((kSoldierUI.m_kSoldier.m_arrRandomPerks.Find(Perk2) + 3) / 3) != ((kSoldierUI.m_kSoldier.m_arrRandomPerks.Length + 3) / 3) )  ) {
							goto endJ;
						}
					}
					else {
	...
	if(I < MergePerk1.Length) {
		...
		if(MergePerkClass[I] == kSoldierUI.m_kSoldier.m_iEnergy) {
...
function PerkStatsPlus(int Pos) {
    ...
    kSoldierUI = XGSoldierUI(kPres.GetMgr(class'XGSoldierUI',,, true));
	kTag = XGParamTag(XComEngine(class'Engine'.static.GetEngine()).LocalizeContext.FindTag("XGParam"));
	kTag.StrValue2 = strMergePerkLabel $ "_" $ strMergePerkDes;
	kPerkMan = kSoldierUI.m_kSoldier.PERKS();
	
	if(kSoldierUI.m_kSoldier.HasPerk(180)) {
		amnesiaperk();
	}
	
	I = 0;
	perknumtest:
	if(I < kSoldierUI.m_kSoldier.m_arrRandomPerks.Length) {
		LogInternal("RandomPerks= " $ string(kSoldierUI.m_kSoldier.m_arrRandomPerks[I]));
		++ I;
		goto perknumtest;
	}
	...
	if(I < MergePerk1.Length) {
		...
		if(((pos + 2) / 3) == 1) {
			if(kPerkMan.GetPerkInTree(kSoldierUI.m_kSoldier.GetClass(), 1, (pos - 1)) == EPerk) {
				goto m;
			}
		}
		if(MergePerkClass[I] == -1 || MergePerkClass[I] == kSoldierUI.m_kSoldier.m_iEnergy) {

		
			if(kSoldierUI.m_kSoldier.m_arrRandomPerks[Pos - 1] == EPerk) {
				m:
				kSoldierUI.m_kSoldier.m_arrRandomPerks[2] = EPerkType(100);
				
				if(arrPerk.Find(MergePerk2[I]) != -1) {
					kSoldierUI.m_kSoldier.m_arrRandomPerks[21] = EPerkType(arrPerk.Find(MergePerk2[I]));
				}
				else {
					K = 0;
					findloop1:
					if(K < arrAlias.Length) {
						if(arrAlias[K].Alias.Find(MergePerk2[I]) != -1) {
							kSoldierUI.m_kSoldier.m_arrRandomPerks[21] = EPerkType(arrAlias[K].Alias.Find(MergePerk2[I]));
							goto endfind1;
						}
						++ K;
						goto findloop1;
			...
			J0x191:
			kSoldierUI.m_kSoldier.m_arrRandomPerks[2] = EPerkType(0);
			kSoldierUI.m_kSoldier.m_arrRandomPerks[21] = EPerkType(0);
		}
		++ I;
		goto J0x190;
	}
	...
	if((((Pos + 2) / 3) == 1) && kSoldierUI.m_kSoldier.m_iEnergy < 30) {
		kClass = kSoldierUI.m_kSoldier.GetClass();
	}
	else {
		kClass = ESoldierClass(byte(kSoldierUI.m_kSoldier.m_iEnergy));
	}
	...
	if(I < PerkStats.Length) {
		...
		if(PerkStats[I].Rank != -1) {
			if(((Pos + 2) / 3) == 1) {
				if(kSoldierUI.m_kSoldier.GetClass() == PerkStats[I].iClass) {
					if(PerkStats[I].Rank == 1) {
				...
				if(ESoldierClass(PerkStats[I].iClass) == kClass) {
					...
					if(PerkStats[I].Rank == ((Pos + 2) / 3)) {
						...
						if(PerkStats[I].Option == opt) {
							if((int(kSoldierUI.m_kSoldier.m_arrRandomPerks[2]) / 100) == 1) {
								kSoldierUI.m_kSoldier.m_arrRandomPerks[2] = EPerkType(100 + (aim * 10) + will);
							}
							else {
								kSoldierUI.m_kSoldier.m_arrRandomPerks[2] = EPerkType((aim * 10) + will);
							}
							if((int(kSoldierUI.m_kSoldier.m_arrRandomPerks[1]) / 100) == 1) {
								kSoldierUI.m_kSoldier.m_arrRandomPerks[1] = EPerkType(100 + (hpmob * 10) + def);
							}
							else {
								kSoldierUI.m_kSoldier.m_arrRandomPerks[1] = EPerkType((hpmob * 10) + def);
							}
							goto J0x70;
						}
					}
			...
			if(PerkStats[I].iClass == -1) {
				...
				if(kSoldierUI.m_kSoldier.m_arrRandomPerks[Pos - 1] == PerkS) {
					ps:
					if((int(kSoldierUI.m_kSoldier.m_arrRandomPerks[2]) / 100) == 1) {
						kSoldierUI.m_kSoldier.m_arrRandomPerks[2] = EPerkType(100 + (aim * 10) + will);
					}
					...
					if((int(kSoldierUI.m_kSoldier.m_arrRandomPerks[1]) / 100) == 1) {
						kSoldierUI.m_kSoldier.m_arrRandomPerks[1] = EPerkType(100);
					}
					else {
						kSoldierUI.m_kSoldier.m_arrRandomPerks[1] = EPerkType(0);
					}
				}
			}
		}
	...
	J0x70:
	//`Log("exit Stat= " $ String(Int(kSoldierUI.m_kSoldier.m_arrRandomPerks[0])));
}
...
function PerkMergePlus(int Perk) {
	...
	if(kSoldierUI.m_kSoldier.HasPerk(EPerkType(Perk))) {
		I = 0;
		J0x02:
		if(I < MergePerk1.Length) {
			...
			if(kSoldierUI.GetAbilityTreeBranch() == 1) {
				goto gmperk;
			}
			...
			if((MergePerkClass[I] == -1) || (MergePerkClass[I] == kSoldierUI.m_kSoldier.m_iEnergy)) {
				gmperk:
				if(Perk1 == Perk) {
					kSoldierUI.m_kSoldier.GivePerk(Perk2);
				}
			}
			++ I;
			goto J0x02;
...
function AugmentDiscountPlus(int cashcost, int meldcost) {
	...
	if(IsAugmentDiscounted) {
		kTag.StrValue2 = string(int(cashcost * (AugmentDiscount / 100.00))) $ "_" $ string(int(meldcost * (AugmentDiscount / 100.00)));
	}
	else {
		kTag.StrValue2 = string(cashcost) $ "_" $ string(meldcost);
	}
	//`Log("AugmentDiscount" @ "cashcost:" @ Left(kTag.StrValue2, InStr(kTag.StrValue2, "_")) $ ", meldcost:" @ split(kTag.StrValue2, "_", true));
...
function amnesiaperk() {
	...
	iCount = kSoldierUI.m_kSoldier.MedalCount();
	...
	if(!(kSoldierUI.m_kSoldier.m_arrRandomPerks[22] > 0)) {
		kSoldierUI.m_kSoldier.m_arrRandomPerks[22] = 0;
	}
	
	kSoldierUI.m_kSoldier.m_arrRandomPerks[22] = EPerkType(kSoldierUI.m_kSoldier.m_arrRandomPerks[22] + 1);
	
	AmUsed = kSoldierUI.m_kSoldier.m_arrRandomPerks[22];
	
	switch(kSoldierUI.m_kSoldier.GetRank()) {
		case 2:
			oRank = 1.9;
			break;
		case 3:
	...
	kSoldierUI.m_kSoldier.m_arrRandomPerks.Length = 0;
	kSoldierUI.m_kSoldier.m_arrRandomPerks.add(24);
	
	kSoldierUI.m_kSoldier.m_arrRandomPerks[22] = EPerkType(AmUsed);
	...
	I = kSoldierUI.m_kSoldier.m_kChar.aStats[7];
	kSoldierUI.m_kSoldier.m_kChar.aStats[7] = class'XGTacticalGameCore'.default.Characters[1].Will;
	
	kBarracks.RandomizeStats(kSoldierUI.m_kSoldier);
	
	switch(AmnesiaWillLossType) {
		case 0:
			break;
		case 1:
			kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= AmnesiaWillLossAmount;
			break;
		case 2:
			kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= (AmnesiaWillLossAmount * kSoldierUI.m_kSoldier.GetRank());
			break;
		case 3:
			kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= (AmnesiaWillLossAmount * kSoldierUI.m_kSoldier.m_arrRandomPerks[22]);
			break;
		case 4:
			kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= (AmnesiaWillLossAmount * kSoldierUI.m_kSoldier.GetRank() * kSoldierUI.m_kSoldier.m_arrRandomPerks[22]);
			break;
		case 5:
			if(I - class'XGTacticalGameCore'.default.Characters[1].Will - (AmnesiaWillLossAmount) > 0) {
				kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= (I - class'XGTacticalGameCore'.default.Characters[1].Will - (AmnesiaWillLossAmount));
			}
			break;
		case 6:
			if(I - class'XGTacticalGameCore'.default.Characters[1].Will - (AmnesiaWillLossAmount * oRank) > 0) {
				kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= (I - class'XGTacticalGameCore'.default.Characters[1].Will - (AmnesiaWillLossAmount * oRank));
			}
			break;
		case 7:
			if(I - class'XGTacticalGameCore'.default.Characters[1].Will - AmnesiaWillLossAmount > 0) {
				kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= ((I - class'XGTacticalGameCore'.default.Characters[1].Will - AmnesiaWillLossAmount) * kSoldierUI.m_kSoldier.m_arrRandomPerks[22]);
			}
			break;
		case 8:
			if(I - class'XGTacticalGameCore'.default.Characters[1].Will - (AmnesiaWillLossAmount * oRank) > 0) {
				kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= ((I - class'XGTacticalGameCore'.default.Characters[1].Will - (AmnesiaWillLossAmount * oRank)) * kSoldierUI.m_kSoldier.m_arrRandomPerks[22]);
			}
			break;
		case 11:
			kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= Rand(AmnesiaWillLossAmount + 1);
			break;
		case 12:
			kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= Rand(AmnesiaWillLossAmount * kSoldierUI.m_kSoldier.GetRank());
			break;
		case 13:
			kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= Rand(AmnesiaWillLossAmount * kSoldierUI.m_kSoldier.m_arrRandomPerks[22]);
			break;
		case 14:
			kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= Rand(AmnesiaWillLossAmount * kSoldierUI.m_kSoldier.GetRank() * kSoldierUI.m_kSoldier.m_arrRandomPerks[22]);
			break;
		case 15:
			RandI = Rand(AmnesiaWillLossAmount + 1);
			if(I - class'XGTacticalGameCore'.default.Characters[1].Will - RandI > 0) {
				kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= (I - class'XGTacticalGameCore'.default.Characters[1].Will - RandI);
			}
			break;
		case 16:
			RandI = Rand(AmnesiaWillLossAmount + 1);
			if(I - class'XGTacticalGameCore'.default.Characters[1].Will - (RandI * oRank) > 0) {
				kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= (I - class'XGTacticalGameCore'.default.Characters[1].Will - (RandI * oRank));
			}
			break;
		case 17:
			RandI = Rand(AmnesiaWillLossAmount + 1);
			if(I - class'XGTacticalGameCore'.default.Characters[1].Will - RandI > 0) {
				kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= ((I - class'XGTacticalGameCore'.default.Characters[1].Will - RandI) * kSoldierUI.m_kSoldier.m_arrRandomPerks[22]);
			}
			break;
		case 18:
			RandI = Rand(AmnesiaWillLossAmount + 1);
			if(I - class'XGTacticalGameCore'.default.Characters[1].Will - (RandI * oRank) > 0) {
				kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= ((I - class'XGTacticalGameCore'.default.Characters[1].Will - (RandI * oRank)) * kSoldierUI.m_kSoldier.m_arrRandomPerks[22]);
			}
			break;
		case 22:
			kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= (Rand(AmnesiaWillLossAmount + 1) * kSoldierUI.m_kSoldier.GetRank());
			break;
		case 23:
			kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= (Rand(AmnesiaWillLossAmount + 1) * kSoldierUI.m_kSoldier.m_arrRandomPerks[22]);
			break;
		case 24:
			kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= (Rand(AmnesiaWillLossAmount + 1) * kSoldierUI.m_kSoldier.GetRank() * kSoldierUI.m_kSoldier.m_arrRandomPerks[22]);
			break;
		case 26:
		...
		case 32:
			...
			break;
		case 33:
			kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= (Rand(AmnesiaWillLossAmount * kSoldierUI.m_kSoldier.m_arrRandomPerks[22]) * kSoldierUI.m_kSoldier.GetRank());
			break;
		case 36:
			RandI = Rand((AmnesiaWillLossAmount + 1) * oRank);
			if(I - class'XGTacticalGameCore'.default.Characters[1].Will - RandI > 0) {
			...
			break;
		case 42:
			kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= Rand(kSoldierUI.m_kSoldier.GetRank()) * AmnesiaWillLossAmount;
			break;
		case 43:
			kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= (Rand(kSoldierUI.m_kSoldier.GetRank() * kSoldierUI.m_kSoldier.m_arrRandomPerks[22]) * AmnesiaWillLossAmount);
			break;
		case 44:
			kSoldierUI.m_kSoldier.m_kChar.aStats[7] -= Rand(kSoldierUI.m_kSoldier.GetRank() * kSoldierUI.m_kSoldier.m_arrRandomPerks[22] * AmnesiaWillLossAmount);
			break;
	...
	if(kSoldierUI.m_kSoldier.HasAnyMedal()) {
		
		if(bAMedalWait) {
			kBarracks.rollstat(kSoldierUI.m_kSoldier, 0, 0);
		}
		else { 
			...
			if(iCount > 0) {
				...
				kSoldierUI.m_kSoldier.m_arrMedals[iCount] = 0;
